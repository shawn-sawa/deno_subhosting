// no-explicit-any, require-await, ban-unused-ignore
// deno-lint-ignore-file  no-unused-vars

// const editor = ace.edit("editor"); // ? this works?
...
window.onload = function () {
  ...
  document.getElementById("deploy-button").addEventListener("click", saveAndDeploy);
